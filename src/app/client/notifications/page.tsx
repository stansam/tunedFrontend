...
import { useClientNotifications } from "./_hooks/useClientNotifications";
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        {unreadCount > 0 && (
          <Button
            ...
            className="bg-emerald-600 hover:bg-emerald-700 text-white rounded-full text-sm font-semibold flex items-center gap-1.5 shadow-sm"
          >

  ...
  return (
    <section
      ...
      className={cn(
        ...
        "overflow-hidden bg-[#f8f7f4] px-4 py-24 text-center"
      )}
    >
      <span
        aria-hidden="true"
      ...
      <div className="relative z-10 flex flex-col items-center gap-5">
        ...
        <div>
          ...
          <p className="mt-3 max-w-md text-slate-500">
            The sample you&apos;re looking for doesn&apos;t exist or may have
            been removed. Browse our full collection to find what you need.
          </p>
        </div>
